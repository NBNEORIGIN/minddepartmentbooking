...
function IntakeForm() {
  ...
  const fetchDisclaimer = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/intake-disclaimer/active/`)
      if (response.ok) {
    ...
    <div className="booking-container">
      ...
      <div className="intake-container">
        <div className="intake-intro">
          ...
          <p>
            To ensure your safety and provide the best possible experience, we need to collect 
            some basic information. This will only take a few minutes and you'll only need to 
            complete this once.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="intake-form">
          ...
          <section className="form-section">
            ...
            <p className="section-description">
              For your safety, we require emergency contact information.
            </p>
          ...
          <section className="form-section">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="e.g., First time, Some experience, Regular practitioner"
              />
            </div>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="What would you like to achieve from your sessions? (Optional)"
                rows={3}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Any preferences or notes for your facilitator? (Optional)"
                rows={3}
              />
            </div>
          </section>
          ...
          <section className="form-section">
            ...
            <div className="checkbox-group">
              <input
                type="checkbox"
                id="consent_booking"
                name="consent_booking"
                checked={formData.consent_booking}
                onChange={handleChange}
                required
              />
              <label htmlFor="consent_booking">
                I consent to booking sessions and storing my booking data *
              </label>
            </div>
            ...
            <div className="checkbox-group">
              ...
              <label htmlFor="consent_marketing">
                I would like to receive updates and wellness information (optional)
              </label>
            </div>
          </section>
